...
func Init(home string, options []string, uidMaps, gidMaps []idtools.IDMap) (graphdriver.Driver, error) {
	...
	if backingFs == "xfs" {
		...
		// The first thing that NewQuotaCtl() does is to call getMaxProjectID()
		// and the first thing it does is check the project id on the home directory.
		// If XFS does not support project quotas, this test will silently
		// fail and cause projectQuotaSupported = false
